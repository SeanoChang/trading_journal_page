...
const components = {
  ...
  h2: (props: any) => (
    <h2
      {...props}
      className="text-stone-300 text-3xl border-b-2 border-slate-400 py-1 my-1"
    />
  ),
  h3: (props: any) => (
    <h3
      {...props}
      className="text-stone-300 text-2xl border-b-2 border-slate-400 py-1 my-1"
    />
  ),
  h4: (props: any) => (
    <h4
      {...props}
      className="text-stone-300 text-xl border-b-2 border-slate-400 py-1 my-1"
    />
  ),
  ...
  blockquote: (props: any) => (
    <blockquote
      {...props}
      className="border-l-4 border-slate-400 pl-4 py-2 italic"
    />
  ),
  code: (props: any) => (
    <code
      {...props}
      className="bg-slate-700 text-slate-100 px-1 py-0.5 rounded text-sm"
    />
  ),
  pre: (props: any) => (
    <pre
      {...props}
      className="bg-slate-800 text-slate-100 p-4 rounded-lg overflow-x-auto my-4"
    />
  ),
  img: (props: any) => (
    <Image
  ...
  table: (props: any) => (
    <table
      {...props}
      className="table-auto border-collapse border border-slate-400 my-4"
    />
  ),
  thead: (props: any) => (
    <thead
      {...props}
      className="table-header-group border-b-[1px] border-slate-300"
    />
  ),
  tbody: (props: any) => (
    <tbody
