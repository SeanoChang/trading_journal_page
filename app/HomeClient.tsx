  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 to-slate-200 dark:from-[#0b0b16] dark:to-[#18182b] text-slate-800 dark:text-slate-100">
      ...
      <motion.div
        ...
        className="pointer-events-none absolute -top-24 -right-24 h-72 w-72 rounded-full bg-white/40 dark:bg-white/5 blur-2xl"
      />
      <motion.div
        aria-hidden
        ...
        className="pointer-events-none absolute -bottom-24 -left-24 h-96 w-96 rounded-full bg-white/40 dark:bg-white/5 blur-3xl"
      />
