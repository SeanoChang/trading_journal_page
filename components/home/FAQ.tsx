...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Server-side quotes via CoinMarketCap, delivered through `/api/prices` and refreshed on the client.",
  },
  {
    key: "3",
    question: "What is MDX?",
    answer:
      "Markdown with components. Write rich notes, embed context, and review with clarity.",
  },
  {
    key: "4",
